...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    handlers=[logging.FileHandler('WriteTFRecord.log'),
...
class ImgObj(ImgObjAbstract):
    ...
    def to_tfexample(self, flag='oid'):
        if flag == 'oid':
            ...
            msg = 'Unkown flag {} for turning ImgObj to tfexample'
            raise NotImplementedError(msg.format(flag))
